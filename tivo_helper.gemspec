...
Gem::Specification.new do |spec|
  ...
  spec.license       = "MIT"
  spec.files         = ["lib/tivo_helper/cli.rb", "lib/tivo_helper/scraper.rb", "lib/tivo_helper/show.rb", "lib/tivo_helper.rb", "lib/tivo_helper/version.rb", "config/environment.rb"]
